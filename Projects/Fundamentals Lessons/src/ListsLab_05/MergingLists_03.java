...
public class MergingLists_03 {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> mergedList = getIntegers(firstFunction, secondFunction);
    ...
    private static ArrayList<Integer> getIntegers(ArrayList<Integer> firstFunction, ArrayList<Integer> secondFunction) {
